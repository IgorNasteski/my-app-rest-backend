...
import io.javabrains.springsecurityjwt.msg.AuthenticationRequest;
import io.javabrains.springsecurityjwt.msg.AuthenticationResponse;
import io.javabrains.springsecurityjwt.msg.UserPasswordResponse;
import io.javabrains.springsecurityjwt.msg.UserUsernameRequest;
...
public class HelloWorldController {
    ...
    //Authorization     (dodam "Bearer" i nalepim vrednost "jwt"-a koji sam poslao useru nakon /authenticate(gde sam kreirao token i poslao mu)
    ...
    //POGLEDA TOKEN U HEDERU(Bearer + jwt) I AKO JE TO ONAJ KOJI SAM SLAO USERU NAKON /authenticate ONDA GA PUSTI JER JE TO ON. KAD KREIRAM TU FILTER KLASU, SAMO DODAM
